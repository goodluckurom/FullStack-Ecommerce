...
const CreateProduct = () => {
  ...
  const handleSubmit = (e) => {
    ...
    images.forEach((image) => {
      productData.append("images", image); // Add the name of the field here
    });
    ...
    productData.append("shopId", seller._id);

    console.log("productData:", productData);

    //dispatches the product to the store
    dispatch(createProduct(productData)); //action to dispatch
  };
  return (
